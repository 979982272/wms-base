...
@Table(name = "crm_out_storage_work_part")
@CreateFlag
@ModifyFlag
public class OutStorageWorkPart {
    @Id
     ...
     * 出库单号
     */
    @Column(name = "out_storage_work")
    @NotEmpty
    private String outStorageWork;
     ...
     * 获取入库单号
     *
     * @return out_storage_work - 入库单号
     */
    public String getOutStorageWork() {
        return outStorageWork;
    }

    /**
     * 设置入库单号
     *
     * @param outStorageWork 入库单号
     */
    public void setOutStorageWork(String outStorageWork) {
        this.outStorageWork = outStorageWork == null ? null : outStorageWork.trim();
    }
